//
//  MockRecipeSyncCoordinator.swift
//  balliTests
//
//  Mock implementation of RecipeSyncCoordinatorProtocol for testing
//
...
@MainActor
final class MockRecipeSyncCoordinator: RecipeSyncCoordinatorProtocol {
    ...
    private func performMockSync() async {
        ...
        if shouldSucceedSync {
            ...
            let error = NSError(
                domain: "MockRecipeSyncCoordinator",
                code: -1,
