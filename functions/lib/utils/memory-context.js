...
exports.hasMemoryContext = hasMemoryContext;
 ...
 */
async function fetchUserFacts(userId, limit = 10) {
    try {
 ...
 */
async function fetchConversationSummaries(userId, limit = 5) {
    try {
 ...
 */
async function hasMemoryContext(userId) {
    try {
        const factsRef = db.collection(`users/${userId}/user_facts`);
