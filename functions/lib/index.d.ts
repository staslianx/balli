...
export declare const getTodayCosts: import("firebase-functions/v2/https").HttpsFunction;
export declare const getWeeklyCosts: import("firebase-functions/v2/https").HttpsFunction;
export declare const getMonthlyCosts: import("firebase-functions/v2/https").HttpsFunction;
export declare const getFeatureCosts: import("firebase-functions/v2/https").HttpsFunction;
