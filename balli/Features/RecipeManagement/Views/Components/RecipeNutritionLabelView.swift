...
//  balli
//
//  Recipe-specific nutrition label component with glycemic load support
//  Duplicated from NutritionLabelView for recipe-specific customizations
//
...
struct RecipeNutritionLabelView: View {
    ...
    @Binding var glycemicLoad: String
    ...
    init(
        ...
        self._fat = fat
        self._glycemicLoad = glycemicLoad
    ...
    private var nutritionSection: some View {
        VStack(alignment: .leading, spacing: ResponsiveDesign.Spacing.medium) {
            ...
            NutritionLabelRowProportional(
                label: "Glisemik Yük",
                baseValue: $glycemicLoad,
                adjustedValue: adjustedGlycemicLoad,
                unit: "",
                isEditing: isEditing,
                portionGrams: portionGrams,
                shouldShow: shouldShowValue("glycemicLoad")
            )
        }
        .padding(.horizontal, ResponsiveDesign.Spacing.large)
    }
...
#Preview {
    struct PreviewWrapper: View {
        @State private var productBrand = "balli"
        @State private var productName = "Izgara Tavuk Salatası"
        @State private var calories = "165"
        @State private var servingSize = "100"
        @State private var carbohydrates = "8"
        @State private var fiber = "3"
        @State private var sugars = "2"
        @State private var protein = "31"
        @State private var fat = "3.6"
        @State private var glycemicLoad = "4"
