...
struct ProductCardView: View {
    ...
    // Brand text color
    private var brandTextColor: Color {
        .primary
    }
    ...
    // Portion text color
    private var portionTextColor: Color {
        .secondary
    }

    // Carbs text color
    private var carbsTextColor: Color {
        .primary
    }
        ...
        VStack(alignment: .leading, spacing: ResponsiveDesign.height(8)) {
            ...
            VStack(alignment: .leading, spacing: ResponsiveDesign.Spacing.xSmall) {
                ...
                Text(portion)
                    ...
                    .foregroundColor(portionTextColor)
                ...
                HStack(alignment: .center, spacing: ResponsiveDesign.Spacing.small) {
                    ...
                    Text(carbs.replacingOccurrences(of: " gr Karb.", with: "gr"))
                        ...
                        .monospacedDigit()
                        .foregroundColor(carbsTextColor)
                        .lineLimit(1)
